# member-share — メンバー限定共有ページ

ランダムslugのURLを知っている人だけが閲覧する限定共有。⚠ リポジトリ自体は公開（GitHub Pages無料枠の制約）のため、URLの秘匿はslugのランダム性に依存する。

**サイトルート: https://senao-routine.github.io/member-share/**

## 公開URL一覧（このURLを叩けば表示される）

| 公開日 | タイトル | URL |
|---|---|---|
| 2026-08-07 | [声で Claude Code を動かす — 導入ガイド（メンバー限定）](https://senao-routine.github.io/member-share/20260807_voice-agent-junow0.html) | https://senao-routine.github.io/member-share/20260807_voice-agent-junow0.html |
